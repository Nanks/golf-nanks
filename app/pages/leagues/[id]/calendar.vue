        ...
        <template v-else>
          ...
          >
            ...
            <div class="flex-1 min-w-0 flex flex-col justify-center">
              <h3 class="text-primary text-xl">{{ event.tees || 'TBD' }}</h3>
            ...
            <div class="flex items-center gap-3 shrink-0">
              ...
              <ClientOnly>
                ...
                <Icon v-else-if="isClickable(event)"
                  ...
                  :class="(event.iso === todayIso && isLeagueLive) ? 'text-emerald-500 animate-pulse' : 'text-slate-300 dark:text-slate-600'"
